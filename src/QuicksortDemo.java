...
class QuickSort {
  ...
  //This method implements in-place (in same array) quicksort algorithm recursively.
  private void quickSort(int low, int high) {
    ...
    while (i <= j) {
       ...
       * pivot value, and * a number from right side which is less then the pivot value.
